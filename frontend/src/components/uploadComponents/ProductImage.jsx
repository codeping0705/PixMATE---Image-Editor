...
const ProductImage = () => {
  const { productPhotography, image, setImage, resultImage, user, loading } =
  ...
  const handleProcess = () => {
    ...
    if (image) productPhotography(image);
  };
    ...
    <div className="max-w-4xl mx-auto p-4 sm:p-8 bg-white shadow-2xl rounded-3xl mt-8 sm:mt-12">
      ...
      <div className="text-center mb-6 sm:mb-10 px-2">
        ...
        <p className="text-gray-600 text-sm sm:text-lg max-w-xl mx-auto">
          Transform your product photos into professional-quality images
          instantly. Upload your product images and enhance them for catalogs,
          e-commerce, or marketing materials with one click.
        </p>
      </div>
